...
SceneBasic_Uniform::SceneBasic_Uniform() : table(100.0f, 100.0f, 1, 1), sun(1.0f, 30, 30), planet1(0.5f, 30, 30), planet2(0.5f, 30, 30)
{
...
void SceneBasic_Uniform::initScene()
{
    ...
    view = glm::lookAt(vec3(10.0f, 10.0f, 10.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f));
    projection = mat4(1.0f);

    //set light position coords
    vec4 lightPos = vec4(20.0f, 50.0f, 20.0f, 0.0f);

     //light uniforms
    prog.setUniform("Light.Ld", 0.3f, 0.3f, 0.3f);
...
void SceneBasic_Uniform::render()
{
    ...
    model = glm::rotate(model, glm::radians(45.0f), vec3(-3.0f, 1.0f, 0.0f));
    setMatrices();
    ogre->render();

    //concrete floor texture
    GLuint woodenTexture = Texture::loadTexture("media/texture/hardwood2_diffuse.jpg");
    glActiveTexture(GL_TEXTURE0);
